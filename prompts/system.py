"""
System prompt generation module for the AI coding agent.

This module aggregates various context guidelines, such as operational instructions,
security policies, identity definition, and repository AGENTS.md specifications,
to generate a comprehensive system prompt for the language model.
"""
...
def get_system_prompt() -> str:
    """Generate the full system prompt from all sections."""
    parts = []
...
def _get_identity_section() -> str:
    """Return the identity and capabilities section of the system prompt."""
    return """# Identity
...
def _get_agents_md_section() -> str:
    """Return the AGENTS.md specification section of the system prompt."""
...
def _get_security_section() -> str:
    """Return the security guidelines section of the system prompt."""
...
def _get_operational_section() -> str:
    """Return the operational guidelines section of the system prompt."""
